...
For what the skill covers and example prompts, see [Skills](https://marinade.gaspatchio.dev/ai/skills/index.md).
...
See [Skills](https://marinade.gaspatchio.dev/ai/skills/index.md) for what to describe.
