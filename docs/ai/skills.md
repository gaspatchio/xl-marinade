...
See the [Quickstart](../quickstart.md) for the `extract → document → diff` walkthrough you can run yourself, and the [CLI](../reference/cli.md) and [SQLite schema](../reference/schema.md) references for the exact contract the skill drives.
